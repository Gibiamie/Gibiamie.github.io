/* Compatibility loader: existing MIC pages are upgraded to MIC v31. */
(() => {
  if (window.__MIC_V31_LOADING) return;
  window.__MIC_V31_LOADING = true;
  const desktop=location.pathname.includes('mic-desktop');
  const base=desktop?'../mic/':'';
  const sub=document.querySelector('.top .sub');
  if(sub)sub.textContent=desktop?'Laptop web · yatırım karar desteği · v31':'Mobil yatırım karar desteği · v31';
  document.title=desktop?'MIC Laptop Web Beta v31':'MIC Mobile Beta v31';
  if('serviceWorker' in navigator&&!desktop)navigator.serviceWorker.register('sw.js?v=31').catch(()=>{});
  ...
  addCss('decision-desk-v31.css?v=31');
  addScript('ipo-calendar-v26.js?v=26');
  addScript('technical-methods-v27.js?v=27',()=>addScript('fakeout-v28.js?v=28',()=>addScript('advanced-methods-v29.js?v=29',()=>addScript('advanced-methods-v29-guard.js?v=29',()=>addScript('macro-context-v30.js?v=30',()=>addScript('decision-desk-v31.js?v=31'))))));
